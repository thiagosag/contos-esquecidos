<?php 
    ...
    if (!isset($_SESSION['email_token'])) { #SE SESSION NÃO EXISTE OU É NULL;
        die("Acesso inválido.");            #MATA;
    };
    $token = $_SESSION['email_token'];
    $link = "http://localhost/Projeto1/web/php/verificaEmail.php?token=".$token;
?>
                    ...
                    <div id="form">
                        <div class="mb-4 bg">
                            <h1>Verifique seu email!</h1>
                                ...
                                <p> Enviamos um link para ativação da sua conta.
